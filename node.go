...
func main() {
	...
	// Iniciamos el servidor médico para todos los nodos (necesario para recibir broadcasts)
	...
	comunicacion.ServicioComunicacion(miID, miHost, dominio, chanLider, chanMensajes)
}